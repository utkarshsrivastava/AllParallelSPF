#!/bin/bash
#SBATCH --error=OpenMP_SM_Regress8.err
#SBATCH --output=OpenMP_SM_Regress8.out
#SBATCH --job-name=CSE603-OpenMP_SM_Regress8
#SBATCH --mail-user=u2@buffalo.edu
#SBATCH --mail-type=ALL
#SBATCH --time=1:00:00 # 1 hours to run this 
...
srun  icc -openmp -o3 -std=c++11 mainDriver.cpp solution.cpp DataRetriever.cpp -o test8
srun ./test8 1 8 1 20
echo "All Done!"
