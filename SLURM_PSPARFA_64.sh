#!/bin/bash
#SBATCH --error=OpenMP_SM_Regress64.err
#SBATCH --output=OpenMP_SM_Regress64.out
#SBATCH --job-name=CSE603-OpenMP_SM_Regress64
#SBATCH --mail-user=u2@buffalo.edu
#SBATCH --mail-type=ALL
#SBATCH --time=12:00:00 # 1 hours to run this 
...
srun  icc -openmp -o3 -std=c++11 mainDriver.cpp solution.cpp DataRetriever.cpp -o test64
srun ./test64 1 64 1 20
echo "All Done!"
