#!/bin/bash
#SBATCH --error=OpenMP_SM_Regress16.err
#SBATCH --output=OpenMP_SM_Regress16.out
...
srun  icc -openmp -o3 -std=c++11 mainDriver.cpp solution.cpp DataRetriever.cpp -o test16
srun ./test16 1 16 1 20
echo "All Done!"
