#!/bin/bash
#SBATCH --error=OpenMP_SM_Regress1.err
#SBATCH --output=OpenMP_SM_Regress1.out
#SBATCH --job-name=CSE603-OpenMP_SM_Regress1
...
srun  icc -openmp -o3 -std=c++11 mainDriver.cpp solution.cpp DataRetriever.cpp -o test1
srun ./test1 1 1 1 20
echo "All Done!"
